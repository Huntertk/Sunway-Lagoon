  ...
  return (
    <section className='bookingDateConfirmationMainContainer'>
        <div className="bookingDateWrapper">
            ...
            {
                selectedDate && type === 'bookTypeOne' && <PreferenceTour data={prefrenceOpt}  /> 
            }

            {
                selectedDate && type === 'bookTypeFour' && <PreferenceTour  data={prefrenceOpt} /> 
            }
            {/* <PreferenceTour /> */}
            <div className="selectedDate">
                {
                    ...
                    </div>
                    {
                        ...
                        }}>Next</button> : type === 'bookTypeTwo' && selectedDate ? <button onClick={() => {
                            dispatch(setBookingDate({selectedBookingDate:format(selectedDate, 'PPP'), selectedDay: selectedDate.toString()}))
                            dispatch(openPaxModel())
                            setCalenderOpen(false)
                        }}>Next</button> : type === 'bookTypeThree' && selectedDate ? <button onClick={() => {
                            dispatch(setBookingDate({selectedBookingDate:format(selectedDate, 'PPP'), selectedDay: selectedDate.toString()}))
                            dispatch(openPaxModel())
                            setCalenderOpen(false)
